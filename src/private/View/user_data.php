    ...
    <main class="my-5">
        <div class="container">
            ...
            <section class="text-center">
                ...
                <form action="../Controllers/blog_controller.php" method="POST">
                    <div class="row my-4">
                        ...
                        <div class="col-md-5 col-sm-12">
                            <textarea name="data" id="data" cols="30" rows="3" placeholder="Enter Your Data"></textarea>
                        </div>
